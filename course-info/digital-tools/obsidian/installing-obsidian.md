...
When you install the vault for the class, it will look like the following window. You can navigate through the different notes and folders via the left sidebar. For more instructions on using Obsidian, also complete [exercise no. 1](../../syllabus/coursework/assignments/1.-introduction-to-hypothes.is.md), integrating Obsidian with hypothesis.&#x20;
