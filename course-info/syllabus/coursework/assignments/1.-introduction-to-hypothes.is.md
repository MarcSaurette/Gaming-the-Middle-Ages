...
* downloaded and installed [Obsidian](broken-reference)
* signed up for a [Hypothes.is](broken-reference) account
...
And finally, right click on your md file in Teams and "copy link". Post this link in the "My first Literature Notes link" in this [spreadsheet](https://docs.google.com/spreadsheets/d/11qySQYeDCusmpIE28vK8rXUAB9KG5S8Ex-gD5SdNE6g/edit?usp=sharing). On this spreadsheet also add other information requested, that you have developed during the [tutorial level](../../../../pregame/tutorial-level.md).&#x20;
