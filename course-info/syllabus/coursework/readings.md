...
Instead of having the bookstore order physical books to campus, we will instead largely use digital files which we will read and annotate together on [Perusall](../../digital-tools/perusall.md).  Perusall allows for [social annotation](http://www.grandviewcetl.org/tools-for-teaching-social-annotation/) which will be a key part of our learning experience this year.

{% hint style="info" %}
You will not need to purchase any textbooks for this class. All readings will be provided as digital copies or links.&#x20;
{% endhint %}
