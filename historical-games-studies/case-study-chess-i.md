...
* On Wednesday, we will explore how to communicate the rules of chess without a chess board in front of you. The goal is to test your ability to communicate the rules of chess just with spoken words. Read through the [outline of the in-class exercise](broken-reference). Students will be divided into _tutors_ and _pupils_ with different responsibilities.
...
On Wednesday, half the class (tutors) will teach the other half of class (pupils) how to play chess. [The exercise is explained here](broken-reference).&#x20;
